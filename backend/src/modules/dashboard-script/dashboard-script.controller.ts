...
@Controller('dashboard-script')
export class DashboardScriptController {
  private readonly kanbancwDomain: string;

  constructor(private readonly config: ConfigService) {
    this.kanbancwDomain = this.config.get<string>('kanbancwDomain')!;
  }
